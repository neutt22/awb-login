...
<div class="terms-conditions-container">
  <div class="row align-center">
    <div class="columns small-12 medium-8 large-6">
      ...
      <h3>Agreement between user and www.loginsvc.com</h3>
      <p>
        Welcome to www.loginsvc.com. The www.loginsvc.com website (the "Site") is comprised of
        various web pages operated by Login Services Corporation ("Login"). www.loginsvc.com is
        offered to you conditioned on your acceptance without modification of the terms, conditions, and
        notices contained herein (the "Terms"). Your use of www.loginsvc.com constitutes your
        agreement to all such Terms. Please read these terms carefully, and keep a copy of them for your
        reference.
      </p>
      <p>
        www.loginsvc.com is a E-commerce Site
        online tool to search, buy and sell aircraft parts
      </p>

      <h3>Electronic Communications</h3>
      <p>
        Visiting www.loginsvc.com or sending emails to Login constitutes electronic communications.
      ...
      <p>
        ...
        transfer your account to any other person or entity. You acknowledge that Login is not
        responsible for third party access to your account that results from theft or misappropriation of
        your account. Login and its associates reserve the right to refuse or cancel service, terminate
        accounts, or remove or edit content in our sole discretion.
      </p>
      <p>
        Login does not knowingly collect, either online or offline, personal information from persons
        under the age of thirteen. If you are under 18, you may use www.loginsvc.com only with
        permission of a parent or guardian.
      </p>

      <h3>Links to third party sites/Third party services</h3>
      <p>
        www.loginsvc.com may contain links to other websites ("Linked Sites"). The Linked Sites are
        not under the control of Login and Login is not responsible for the contents of any Linked Site,
        including without limitation any link contained in a Linked Site, or any changes or updates to a
        Linked Site. Login is providing these links to you only as a convenience, and the inclusion of
        any link does not imply endorsement by Login of the site or any association with its operators.
      </p>
      <p>
        Certain services made available via www.loginsvc.com are delivered by third party sites and
        organizations. By using any product, service or functionality originating from the
        www.loginsvc.com domain, you hereby acknowledge and consent that Login may share such
        information and data with any third party with whom Login has a contractual relationship to
        provide the requested product, service or functionality on behalf of www.loginsvc.com users and
        customers.
      </p>
      ...
      <p>
        ...
        www.loginsvc.com strictly in accordance with these terms of use. As a condition of your use of
        the Site, you warrant to Login that you will not use the Site for any purpose that is unlawful or
      ...
      <p>
        ...
        compilation thereof, and any software used on the Site, is the property of Login or its suppliers
      ...
      <p>
        ...
        Login content is not for resale. Your use of the Site does not entitle you to make any
        ...
        permission of Login and the copyright owner. You agree that you do not acquire any ownership
        rights in any protected content. We do not grant you any licenses, express or implied, to the
        intellectual property of Login or our licensors except as expressly authorized by these Terms.
      </p>
      ...
      <p>
        Login has no obligation to monitor the Communication Services. However, Login reserves the
        right to review materials posted to a Communication Service and to remove any materials in its
        sole discretion. Login reserves the right to terminate your access to any or all of the
        Communication Services at any time without notice for any reason whatsoever.
      </p>
      <p>
        Login reserves the right at all times to disclose any information as necessary to satisfy any
        applicable law, regulation, legal process or governmental request, or to edit, refuse to post or to
        remove any information or materials, in whole or in part, in Login's sole discretion.
      </p>
      <p>
        Always use caution when giving out any personally identifying information about yourself or
        your children in any Communication Service. Login does not control or endorse the content,
        messages or information found in any Communication Service and, therefore, Login specifically
        disclaims any liability with regard to the Communication Services and any actions resulting from
        your participation in any Communication Service. Managers and hosts are not authorized Login
        spokespersons, and their views do not necessarily reflect those of Login.
      </p>
      <p>
      ...
      <h3>Materials provided to www.loginsvc.com or posted on any Login web page</h3>
      <p>
        Login does not claim ownership of the materials you provide to www.loginsvc.com (including
        feedback and suggestions) or post, upload, input or submit to any Login Site or our associated
        services (collectively "Submissions"). However, by posting, uploading, inputting, providing or
        submitting your Submission you are granting Login, our affiliated companies and necessary
      ...
      <p>
        ...
        Login is under no obligation to post or use any Submission you may provide and may remove
        any Submission at any time in Login's sole discretion.
      </p>
      <p>
      ...
      <p>
        The Service is controlled, operated and administered by Login from our offices within the USA.
        If you access the Service from a location outside the USA, you are responsible for compliance
        with all local laws. You agree that you will not use the Login Content accessed through
        www.loginsvc.com in any country or in any manner prohibited by any applicable laws,
        restrictions or regulations.
      </p>

      <h3>Indemnification</h3>
      <p>
        You agree to indemnify, defend and hold harmless Login, its officers, directors, employees,
        ...
        any rights of a third party, or your violation of any applicable laws, rules or regulations. Login
        reserves the right, at its own cost, to assume the exclusive defense and control of any matter
        otherwise subject to indemnification by you, in which event you will fully cooperate with Login
      ...
      <p>
        ...
        INFORMATION HEREIN. LOGIN SERVICES CORPORATION AND/OR ITS SUPPLIERS
        MAY MAKE IMPROVEMENTS AND/OR CHANGES IN THE SITE AT ANY TIME.
      </p>
      <p>
        LOGIN SERVICES CORPORATION AND/OR ITS SUPPLIERS MAKE NO
        ...
        PROVIDED "AS IS" WITHOUT WARRANTY OR CONDITION OF ANY KIND. LOGIN
        SERVICES CORPORATION AND/OR ITS SUPPLIERS HEREBY DISCLAIM ALL
      ...
      <p>
        ...
        SHALL LOGIN SERVICES CORPORATION AND/OR ITS SUPPLIERS BE LIABLE FOR
        ...
        LOGIN SERVICES CORPORATION OR ANY OF ITS SUPPLIERS HAS BEEN ADVISED
      ...
      <p>
        Login reserves the right, in its sole discretion, to terminate your access to the Site and the related
        ...
        exclusive jurisdiction and venue of courts in Florida in all disputes arising out of or relating to
      ...
      <p>
        ...
        you and Login as a result of this agreement or use of the Site. Login's performance of this
        agreement is subject to existing laws and legal process, and nothing contained in this agreement
        is in derogation of Login's right to comply with governmental, court and law enforcement
        requests or requirements relating to your use of the Site or information provided to or gathered
        by Login with respect to such use. If any part of this agreement is determined to be invalid or
      ...
      <p>
        ...
        user and Login with respect to the Site and it supersedes all prior or contemporaneous
        communications and proposals, whether electronic, oral or written, between the user and Login
      ...
      <p>
        Login reserves the right, in its sole discretion, to change the Terms under which
        www.loginsvc.com is offered. The most current version of the Terms will supersede all previous
        versions. Login encourages you to periodically review the Terms to stay informed of our
        updates.
      </p>
    </div>
  </div>
